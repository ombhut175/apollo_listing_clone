...
const SocialShare: React.FC<SocialShareProps> = ({
  ...
  return (
    <div className="social-share-container">
      <h4 className="share-title">Share this listing</h4>
      <div className="social-share-buttons">
        <a 
          href={facebookShareUrl} 
          onClick={(e) => handleShareClick(e, facebookShareUrl)}
        ...
        <a 
          ...
          onClick={(e) => handleShareClick(e, pinterestShareUrl)}
        ...
        <a 
          ...
          onClick={(e) => handleShareClick(e, whatsappShareUrl)}
          className="social-share-button whatsapp"
          aria-label="Share on WhatsApp"
          title="Share on WhatsApp"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <path d="M17.498 14.382c-.301-.15-1.767-.867-2.04-.966-.273-.101-.473-.15-.673.15-.197.295-.771.964-.944 1.162-.175.195-.349.21-.646.075-.3-.15-1.263-.465-2.403-1.485-.888-.795-1.484-1.77-1.66-2.07-.174-.3-.019-.465.13-.615.136-.135.301-.345.451-.523.146-.181.194-.301.297-.496.1-.21.049-.375-.025-.524-.075-.15-.672-1.62-.922-2.206-.24-.584-.487-.51-.672-.51-.172-.015-.371-.015-.571-.015-.2 0-.523.074-.797.359-.273.3-1.045 1.02-1.045 2.475s1.07 2.865 1.219 3.075c.149.195 2.105 3.195 5.1 4.485.714.3 1.27.48 1.704.629.714.227 1.365.195 1.88.121.574-.091 1.767-.721 2.016-1.426.255-.705.255-1.29.18-1.425-.074-.135-.27-.21-.57-.345m-5.446 7.443h-.016c-1.77 0-3.524-.48-5.055-1.38l-.36-.214-3.75.975 1.005-3.645-.239-.375a9.869 9.869 0 0 1-1.516-5.26c0-5.445 4.455-9.885 9.942-9.885a9.865 9.865 0 0 1 7.022 2.92 9.788 9.788 0 0 1 2.896 6.965c-.004 5.445-4.455 9.885-9.929 9.885m8.58-18.46c-2.321-2.321-5.4-3.595-8.58-3.595-6.714 0-12.171 5.445-12.171 12.159 0 2.13.54 4.215 1.584 6.076l-1.676 6.105 6.27-1.641a12.145 12.145 0 0 0 5.979 1.527h.004c6.714 0 12.171-5.445 12.171-12.159 0-3.255-1.267-6.31-3.582-8.612" />
          </svg>
        </a>
        <a 
          href={emailShareUrl} 
